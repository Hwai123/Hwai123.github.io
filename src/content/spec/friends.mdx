...
export const site = {
  name: "Toadally",
  desc: "Personal Blog of Toadally",
  url: "https://Hwai123.github.io",
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">通过 GitHub 联系我：<code class="px-1.5 py-0.5 rounded bg-black/5 dark:bg-white/10 text-[0.7rem]">github.com/Hwai123</code></p>
